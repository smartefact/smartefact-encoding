...
/**
 * {@link OutputStream} wrapper that uses a {@link BinaryCoder} to code the bytes written.
 *
 ...
 */
public final class BinaryCodingOutputStream extends OutputStream {
    ...
    public BinaryCodingOutputStream(
        BinaryCoder coder,
