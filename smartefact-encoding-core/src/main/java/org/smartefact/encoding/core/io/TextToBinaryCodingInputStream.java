...
/**
 * {@link Reader} wrapper that uses a {@link TextToBinaryCoder} to code the characters read.
 *
 * @author Laurent Pireyn
 */
public final class TextToBinaryCodingInputStream extends AbstractInputStream {
    ...
    public TextToBinaryCodingInputStream(
