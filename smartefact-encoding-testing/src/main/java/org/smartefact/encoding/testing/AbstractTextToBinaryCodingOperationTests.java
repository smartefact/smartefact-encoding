...
/**
 * Abstract {@link TextToBinaryCodingOperation} tests.
 *
 * @author Laurent Pireyn
 */
abstract non-sealed class AbstractTextToBinaryCodingOperationTests extends AbstractCodingOperationTests {
    @Override
    abstract TextToBinaryCoder getCoder();

    abstract Stream<TextToBinaryTestData> getData();
    ...
    void testCode(
        ...
        final var output = new TestTextToBinaryCodingRunner(getCoder(), input)
